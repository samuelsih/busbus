                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="BRI"></asp:ListItem>
                                <asp:ListItem Value="2" Text="BNI"></asp:ListItem>
                                <asp:ListItem Value="3" Text="BSI"></asp:ListItem>
                                <asp:ListItem Value="4" Text="BCA"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Bank Mandiri"></asp:ListItem>
                            </asp:DropDownList>
